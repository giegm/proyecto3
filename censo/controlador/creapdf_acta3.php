...
<body>
	...
	<h3 id="titulos-de-tablas">CONSTANCIA DE NO POSEER EMPLEO</h3>	
	
	<div class="col-xs-12 col-sm-8 col-md-3">
	<center>
		<p style="text-align: justify;">El Concejo Comunal Santa Inés debidamente registrado bajo el Nº 0101210010228, ante la oficina de fundacomunal, mediante la presente hace del  conocimiento de  quien  pueda Interesar que la Sr. (a) #, titular de la CI.V- #, y residente de la de la carretera vieja Caracas la Guaira sector Blandin la Cadena e este concejo comunal hacemos constar que la misma en la actualidad no posee un Empleo Conocido y por ser esta cabeza de hogar solicitamos a las instituciones se sirvan brindar el apoyo necesario en cuanto a las gestiones que por ante ellas realice la persona previamente  identificada siempre manteniéndose dentro de las  normas  legales.

		</p>

		<p style="text-align: justify;">Sin más a que hacer referencia  y esperando la mayor colaboración se despide  </p>

		<p style="text-align: justify;">CONSTANCIA QUE SE EMITE A PETICION  DE  LA  PARTE  INTERESADA <?php setlocale(LC_TIME, "es-VE"); echo strftime("%A %d DEL MES DE %B DE %Y"); ?> </p>		
