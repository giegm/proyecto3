    ...
    <div class="panel-body">
      <form action="../controlador/procesa_noticia.php" method="POST" class="form-horizontal" enctype="multipart/form-data" name="form" role="form">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-7 col-md-6">
            <div class="required-field-block">
              <input type="text" class="form-control" name="titulo_noticia" value="" maxlength="30" title="Máximo 30 caracteres" placeholder="Indique el título de la noticia">
              <div class="required-icon">
                <div class="text">*</div>
              </div>
            </div>
         ...
         <div class="form-group">
          ...
          <textarea name="descrip_noticia" maxlength="300" title="Máximo 300 caracteres" placeholder="Describa el contenido de la noticia"></textarea>
          </div>
         </div>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-10 col-md-8">
              <input type="button" class="btn btn-success" onclick="Validar_Noticia(); filtrarPalabras();" value="Cargar Noticia">
