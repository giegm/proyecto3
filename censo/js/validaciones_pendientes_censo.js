...
function Validar_censo(){
	...
	if(form.cne_f.value==null || form.cne_f.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.disc.value==null || form.disc.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.pens.value==null || form.pens.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.trabaja.value==null || form.trabaja.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.tipoing.value==null || form.tipoing.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.ingmens.value==null || form.ingmens.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.nivinstruc.value==null || form.nivinstruc.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.profesion.value==null || form.profesion.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
...
/*////////////////////////////////////////////////////////////////////////*/
	...
	if(form.donde_trabaja.value==null || form.donde_trabaja.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.ing_familiar.value==null || form.ing_familiar.value == null){
		//document.getElementById("mensaje_error").innerHTML="";
...
/*/////////////////////////////////////////////////////////////////////////////////////////////*/
	...
	//validamos si el terreno es propio
	if(form.terreno_propio.value==null || form.terreno_propio.value == null || form.terreno_propio.value == " "){
		//document.getElementById("mensaje_error").innerHTML=".";
	...
	if(form.tipo_paredes.value==null || form.tipo_paredes.value == null || form.tipo_paredes.value == " "){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.tipo_techo.value==null || form.tipo_techo.value == null || form.tipo_techo.value == " "){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	//validamos el SIVIH
	if(form.SIVIH.value==null || form.SIVIH.value == null || form.SIVIH.value == " "){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	//validamos la LPH
	if(form.ley_phab.value==null || form.ley_phab.value == null || form.ley_phab.value == " "){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.salubridad_vivienda.value==null || form.salubridad_vivienda.value == null || form.salubridad_vivienda.value == " "){
		//document.getElementById("mensaje_error").innerHTML="";
...
//validamos los litros del tanque
	...
	if(form.otra_area.value==null || form.otra_area.value ==null || form.otra_area.value ==" "){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.names_encuestado.value==null || form.names_encuestado.value==null || form.names_encuestado.value==0){
		//document.getElementById("mensaje_error").innerHTML="";
	...
	if(form.ced_encuestado.value==null || form.ced_encuestado.value==null || form.ced_encuestado.value==0){
		//document.getElementById("mensaje_error").innerHTML="";
