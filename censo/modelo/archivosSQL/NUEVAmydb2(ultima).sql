...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-11-2016 a las 21:01:13
...
CREATE TABLE `condiciones_salud` (
  ...
  `SITUACION_EXCLUSION` varchar(10) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `SITUACION_EXCLUSION1` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION2` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION3` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION4` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION5` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `detalles_vivienda` (
  ...
  `ENSERES_VIVIENDA8` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
