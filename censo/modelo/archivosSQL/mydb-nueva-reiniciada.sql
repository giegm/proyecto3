...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-11-2016 a las 05:44:35
...
CREATE TABLE `condiciones_salud` (
  ...
  `PERSONA_ENFERMEDAD1` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD3` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD4` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD5` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD6` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD7` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD8` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD9` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `PERSONA_ENFERMEDAD10` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  ...
  `SITUACION_EXCLUSION1` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION3` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION4` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION5` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SITUACION_EXCLUSION6` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `detalles_vivienda` (
  ...
  `ENSERES_VIVIENDA` varchar(60) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `ENSERES_VIVIENDA2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ENSERES_VIVIENDA3` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA4` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA5` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA6` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA7` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA8` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA9` int(15) DEFAULT NULL,
  `ENSERES_VIVIENDA10` int(15) DEFAULT NULL,
  ...
  `INSECTOS_ROEDORES6` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS` varchar(20) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `ANIMALES_DOMESTICOS2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS3` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS4` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS5` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS6` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS7` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ANIMALES_DOMESTICOS8` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ID_JEFE` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `participacion_comunitaria` (
  ...
  `MISIONES_COMUNIDAD1` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `MISIONES_COMUNIDAD2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `MISIONES_COMUNIDAD3` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `MISIONES_COMUNIDAD4` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `MISIONES_COMUNIDAD5` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `MISIONES_COMUNIDAD6` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `MISIONES_COMUNIDAD7` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `preguntas_part_comunitaria` (
  ...
  `P_DOCE1` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE2` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE3` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE4` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE5` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE6` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE7` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE8` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  `P_DOCE9` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `situacion_servicios` (
  ...
  `TELEFONIA1` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TELEFONIA2` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TELEFONIA3` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TELEFONIA4` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TELEFONIA5` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TRANSPORTE` varchar(30) DEFAULT NULL,
  `TIPO_INFORMACION` varchar(40) DEFAULT NULL,
  `TIPO_INFORMACION1` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TIPO_INFORMACION2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TIPO_INFORMACION3` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TIPO_INFORMACION4` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `TIPO_INFORMACION5` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES` varchar(30) DEFAULT NULL,
  `SERV_COMUNALES1` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES2` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES3` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES4` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES5` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES6` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES7` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES8` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES9` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES10` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES11` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `SERV_COMUNALES12` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL,
  `ID_JEFE` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
