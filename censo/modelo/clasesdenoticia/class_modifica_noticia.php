...
class MNoticia{
	...
	$sql=mysqli_query(Conecta::conx(),"update noticias_web set TITULO_NOTICIA='$tit',FCHA_NOTICIA='$fcha',HORA='now()',DESCRIPC_NOTICIA='$descrip',ID_CATEGORIA='$cat',ID_PERFIL='$id' where ID_NOTICIA=$id_not")or die('Problemas al intentar modificar la noticia:' . $sql . mysqli_errno(Conecta::conx()));
