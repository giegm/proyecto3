	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "Ver _MENU_ Censos",
				"sZeroRecords": "No se produjo ningún resultado",
				"sEmptyTable": "No existen censos para mostrar",
				"sInfo": "Resultado _START_ - _END_ de _TOTAL_ Censos",
				"sInfoEmpty": "Registros 0 - 0 de 0 Entradas",
				"sInfoFiltered": "(Filtrado de _MAX_ censos)",
				"sInfoPostFix": "",
				"sSearch": "Buscar:",
				"sUrl": "",
				"oPaginate": {
