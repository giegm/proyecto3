				...
				<section><!-- inicio del section del contenedor central admin -->
					<div class="col-md-10 col-admin-central"><!-- contenedor central admin -->
						...
						"Septiembre","Octubre","Noviembre","Diciembre"); 
							...
							<div class="div_contenido_censo"><br><br><br>
							<h3 id="titulos-de-tablas"><center>CARTA DE RESIDENCIA</center></h3><br>	
							...
							<center>
								...
								<br>
								<p style="text-align: justify;">Constancia que se expide a petición de la parte interesada en Caracas <script> document.write("<small><font color='black' face='Arial'><b>" + daym + " de " + montharray[month] + " de " + year + "</b></font></small>");     </script> </p>
							</center>
							</div>	
							...
							<br><br>
							<center><a class="btn btn-success" type="button" href="../controlador/creapdf_acta.php">Imprimir</a></center>
						</div>
