...
$data=$objc->obten_censo_por_id($_GET["id"]);
?>
<!DOCTYPE html>
<html lang="es">
	<head>
		<title>Sistema de Control de Censo Demográfico y Socieconómico|Revisar Censo</title>
		<meta charset="utf-8">
			...
			<section>
				<div class="col-md-10 col-admin-central">
					...
					<div class="col-md-12 well">
						...
						<form action="revisar_censo.php" method="POST" name="form" class="form-horizontal" role="form">
							...
							<!-- comienzo de los paneles agrupados -->
								...
								<?php include("../includes/revisioncenso/datosdelcenso.php");?>
								...
								<div class="form-group"><!-- 2do form-group -->
									...
									<div class="col-sm-8 col-md-8">
										<?php include("../includes/revisioncenso/botones_update.php");?>
									</div>
								</div>
							</div>
						</form>
