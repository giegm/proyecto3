...
<nav class="navbar navbar-default navbar-static-top" id="navbar-index">
  <div class="container-fluid" id="container-navbar-admin">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="../vistas/administra.php"><span class="nombre-sistema">Sistema de control M.T.</span></a>
    </div>
    <!-- elementos navbar -->
    <div class="navbar-collapse collapse" id="btn-responsive">
     <ul class="nav navbar-nav navbar-right">

      <li><a href="" title=""><script> 
      document.write("<small><font color='white' face='Arial'><b>"+ dayarray[day] + " " + daym + " de " + montharray[month] + " de " + year + "</b></font></small>"); 
      </script></a></li>
      ...
      if($_SESSION["sesion_perfil"]==1)
       ...
       <li><a href="../vistas/administra.php"><i class="fa fa-eye visible-sm visible-md"></i><span class="visible-xs visible-lg">Vista general</span></a></li>
       ...
       <li><a href="../vistas/soporte.php"><i class="fa fa-plus-square visible-sm visible-md"></i><span class="visible-xs visible-lg">Ayuda</span></a></li>
